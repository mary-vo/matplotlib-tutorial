...
# Plotting functions expect numpy.array, numpy.ma.masked_array, or objects that can be passed to numpy.asarray as input
# Converting numpy.matrix top numpy.array
b = np.matrix([[1, 2], [3, 4]])
